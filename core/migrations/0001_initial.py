# Generated by Django 5.2.11 on 2026-02-20 12:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('STUDENT', 'Student'), ('COMPANY', 'Company'), ('ADMIN', 'Admin / Placement Officer')], default='STUDENT', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stipend_or_ctc', models.CharField(blank=True, max_length=100)),
                ('eligibility_cgpa', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True)),
