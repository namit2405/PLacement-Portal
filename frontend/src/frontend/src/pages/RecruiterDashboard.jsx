...
function MyJobsTab({ onViewApplicants }) {
 ...
 {job.location} {job.stipendOrSalary}
 {job.eligibility_cgpa ? ` Min CGPA: ${job.eligibility_cgpa}` : ""}
 </p>
...
function ApplicantsTab() {
 ...
 <SelectContent>
 {myJobs.map((job) => (
 <SelectItem key={job.id} value={String(job.id)}>{job.title} {job.company?.name}</SelectItem>
 ))}
 </SelectContent>
 </Select>
 </CardContent>
