 ...
 */
export function getUrlParameter(paramName) | null {
 ...
 */
export function getSessionParameter(key) | null {
  try {
 ...
 */
export function getSecretFromHash(paramName) | null {
 ...
 */
export function getSecretParameter(paramName) | null {
